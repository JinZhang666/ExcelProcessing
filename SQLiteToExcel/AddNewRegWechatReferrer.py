...
def addSheet6WechatReferrer():
    ...
    df = df[['CREATETIME','MOBILENO','MARKET_CODE','REFERRER_ID',\
             'DEPARTMENT_ID','PAGE_INDEX','NICK_NAME','',\
             '有效入金','入金日期','有效交易','交易日期',\
    ...
    workbookdes.save('../output/ACC+VAL+WECHATExpanded.xls')
